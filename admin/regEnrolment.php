<!--
    This file is responsible for the view layer of the regEnrolment page. It controls user input and output.
-->
...
<?php 
    ...
    include './controller/contRegEnrolment.php';
?>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <!-- Page Header -->
                    <h1 class="page-header">Enrol Student</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
